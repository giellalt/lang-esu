...
all: esu.ana.hfstol esu.seg.gen.hfstol esu.3rd.hfst esu.4th.hfst

### esu.seg.gen.hfstol
# 1. esu.lexc         = esu.lexc.only.hfst
# 2. esu.lexc.xfst    = esu.lexc.hfst
# 3. esu.twol         = esu.3rd.hfst
# 4. esu.stress.twol  = esu.4th.hfst
# 5. esu.twol.xfst    = esu.gen.seg.hfst
# 6. esu.seg.twol     = esu.seg.gen.hfstol
...
esu.lexc.only.hfst: srcV2/esu.lexc
	./hfst-3.16.0/bin/hfst-lexc --Werror srcV2/esu.lexc -o esu.lexc.only.hfst 
...
esu.lexc.xfst.hfst: srcV2/esu.lexc.xfst
	./hfst-3.16.0/bin/hfst-xfst -p -e "source $<" -e "save stack $@" -E "hyvästi" #"exit"
...
esu.twol.hfst: srcV2/esu.twol
	./hfst-3.16.0/bin/hfst-twolc -i srcV2/esu.twol -o esu.twol.hfst

# This is the phonology file, which assigns stress to vowels
#   cali>nrit0>>>uq
#   calí>nrit0>>>uq
esu.stress.hfst: srcV2/esu.stress.twol
	./hfst-3.16.0/bin/hfst-twolc -i srcV2/esu.stress.twol -o esu.stress.hfst
...
esu.seg.twol.hfst: srcV2/esu.seg.twol
	./hfst-3.16.0/bin/hfst-twolc -i srcV2/esu.seg.twol -o esu.seg.twol.hfst

# This is the phonology file, which removes morpheme boundaries
#   cali>nrit>>>uq
#   cali0nrit000uq
esu.ana.twol.hfst: srcV2/esu.ana.twol
	./hfst-3.16.0/bin/hfst-twolc -i srcV2/esu.ana.twol -o esu.ana.twol.hfst
...
esu.lexc.hfst: esu.lexc.only.hfst esu.lexc.xfst.hfst 
	./hfst-3.16.0/bin/hfst-compose -1 esu.lexc.only.hfst -2 esu.lexc.xfst.hfst -o esu.lexc.hfst
esu.lexc.permissive.hfst: esu.lexc.only.hfst esu.lexc.permissive.xfst.hfst 
	./hfst-3.16.0/bin/hfst-compose -1 esu.lexc.only.hfst -2 esu.lexc.permissive.xfst.hfst -o esu.lexc.permissive.hfst


esu.3rd.hfst: esu.lexc.hfst esu.twol.hfst esu.stress.hfst esu.twol.xfst.hfst 
	./hfst-3.16.0/bin/hfst-compose-intersect -1 esu.lexc.hfst -2 esu.twol.hfst | hfst-minimise -o esu.3rd.hfst
esu.4th.hfst: esu.lexc.hfst esu.twol.hfst esu.stress.hfst esu.twol.xfst.hfst 
	./hfst-3.16.0/bin/hfst-compose-intersect -1 esu.lexc.hfst -2 esu.twol.hfst | hfst-compose-intersect -1 - -2 esu.stress.hfst | hfst-minimise -o esu.4th.hfst
...
esu.gen.seg.hfst: esu.lexc.hfst esu.twol.hfst esu.stress.hfst esu.twol.xfst.hfst 
	./hfst-3.16.0/bin/hfst-compose-intersect -1 esu.lexc.hfst -2 esu.twol.hfst | hfst-compose-intersect -1 - -2 esu.stress.hfst | hfst-compose -1 - -2 esu.twol.xfst.hfst | hfst-minimise -o esu.gen.seg.hfst
esu.gen.seg.permissive.hfst: esu.lexc.permissive.hfst esu.twol.hfst esu.stress.hfst esu.twol.permissive.xfst.hfst 
	./hfst-3.16.0/bin/hfst-compose-intersect -1 esu.lexc.permissive.hfst -2 esu.twol.hfst | hfst-compose-intersect -1 - -2 esu.stress.hfst | hfst-compose -1 - -2 esu.twol.permissive.xfst.hfst | hfst-minimise -o esu.gen.seg.permissive.hfst
...
esu.gen.permissive.hfst: esu.gen.seg.permissive.hfst esu.ana.twol.hfst
	./hfst-3.16.0/bin/hfst-compose-intersect -1 esu.gen.seg.permissive.hfst -2 esu.ana.twol.hfst | hfst-minimise -o esu.gen.permissive.hfst

# This is the analyser that does not have morpheme boundaries
#   calinrituq
#	cali-–nrite[V→V][V][Intr][Ind][S_3Sg]
esu.ana.hfst: esu.gen.permissive.hfst
	./hfst-3.16.0/bin/hfst-invert esu.gen.permissive.hfst -o esu.ana.hfst

# This is the generator that keeps morpheme boundaries
#	cali-–nrite[V→V][V][Intr][Ind][S_3Sg]
#   cali>nrit>uq
esu.seg.gen.hfst: esu.gen.seg.hfst esu.seg.twol.hfst
	./hfst-3.16.0/bin/hfst-compose-intersect -1 esu.gen.seg.hfst -2 esu.seg.twol.hfst | hfst-minimise -o esu.seg.gen.hfst
...
esu.ana.hfstol: esu.ana.hfst
	./hfst-3.16.0/bin/hfst-fst2fst -w esu.ana.hfst -o esu.ana.hfstol
esu.seg.gen.hfstol: esu.seg.gen.hfst
	./hfst-3.16.0/bin/hfst-fst2fst -w esu.seg.gen.hfst -o esu.seg.gen.hfstol
